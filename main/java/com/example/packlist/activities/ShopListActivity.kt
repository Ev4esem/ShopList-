...
import com.example.packlist.databinding.ActivityShopListBinding
import com.example.packlist.db.MainViewModel
import com.example.packlist.db.ShopListItemAdapter
import com.example.packlist.dialogs.EditListItemDialog
...
import com.example.packlist.utils.ShareHelper
...
class ShopListActivity : AppCompatActivity(), ShopListItemAdapter.Listener {
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        menuInflater.inflate(R.menu.shop_list_name_menu, menu)
    ...
    //Это функция следит когда открывается actionView и когда закрывается
    private fun expandActionView(): MenuItem.OnActionExpandListener {
        return object : MenuItem.OnActionExpandListener {
            //эта функция показывает нашу кнопку
            ...
            //Это функция закрывает нашу кнопку
    ...
    override fun onClickItem(shopListItem: ShopListItem, state: Int) {
        when (state) {
            ...
            ShopListItemAdapter.DELETE_LIST_ITEM -> {
                mainViewModel.deleteListItem(shopListItem.id!!)
            }
        }
    }
